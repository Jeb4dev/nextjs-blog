...
export default function Layout({ children, posts, footer, formImage, meta }) {
  return (
    <div>
            ...
            <div className={styles.container + "mb-0"}>
              <div className={"py-8 flex flex-col items-center gap-12"}>
                <h1 className={"max-w-[20rem] text-white text-4xl font-semibold text-center"}>
                  ...
                  <span className={"underline underline-offset-8 decoration-4 text-cyan-500"}>css</span> skills.
                </h1>
                <p className={"text-white text-center max-w-[34rem]"}>
                  No real function for this, but this will give us a good indication for your level of expertise with
                ...
                <div className={"md:flex-1"}>
                  <div className="relative h-[400px] group overflow-hidden">
                    <Image
                      ...
                      objectFit={"cover"}
                      className={
                        "h-full blur-sm md:blur-0 transform md:group-hover:scale-110 transition duration-300 ease-in-out"
                      }
                    />
                    <div
                  ...
                  <form className={"h-full flex flex-col items-center justify-center px-4"} action="">
                    <div className="py-8 flex justify-center items-center">
                      <label className="relative cursor-pointer">
                        ...
                        />
                        <span className="text-2xl text-gray-200 md:text-gray-500 md:bg-white md:text-opacity-80 absolute left-5 top-5 px-1 transition duration-200 input-text">
                          Label
                        </span>
                      </label>
                    </div>
